...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface BackerBadgeInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "badgeData" | "balanceOf" | "getApproved" | "isApprovedForAll" | "mint" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'badgeData', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'badgeData', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface BackerBadge extends BaseContract {
    
    connect(runner?: ContractRunner | null): BackerBadge;
    waitForDeployment(): Promise<this>;

    interface: BackerBadgeInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    badgeData: TypedContractMethod<
      [arg0: BigNumberish, ],
      [[string, bigint, bigint, bigint] & {campaignTitle: string, amountContributed: bigint, contributionDate: bigint, campaignId: bigint }],
      'view'
    >
    ...
    mint: TypedContractMethod<
      [to: AddressLike, campaignTitle: string, amountContributed: BigNumberish, campaignId: BigNumberish, ],
      [bigint],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'approve'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'badgeData'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [[string, bigint, bigint, bigint] & {campaignTitle: string, amountContributed: bigint, contributionDate: bigint, campaignId: bigint }],
      'view'
    >;
